...
def test_code(test_case):
    ...
    def TF_matrix(s, theta, alpha, d, a):
    ...
    T0_1 = TF_matrix(s=s, theta=theta1, alpha=alpha0, d=d1, a=a0)
    T1_2 = TF_matrix(s=s, theta=theta2, alpha=alpha1, d=d2, a=a1)
    T2_3 = TF_matrix(s=s, theta=theta3, alpha=alpha2, d=d3, a=a2)
    ...
    T3_4 = TF_matrix(s=s, theta=theta4, alpha=alpha3, d=d4, a=a3)
    T4_5 = TF_matrix(s=s, theta=theta5, alpha=alpha4, d=d5, a=a4)
    T5_6 = TF_matrix(s=s, theta=theta6, alpha=alpha5, d=d6, a=a5)
    T6_G = TF_matrix(s=s, theta=theta7, alpha=alpha6, d=d7, a=a6)
    ...
    your_ee = [fk_ee_x, fk_ee_y, fk_ee_z] # <--- Load your calculated end effector value from your forward kinematics
    ########################################################################################
