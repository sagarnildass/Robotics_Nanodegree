...
In Inverse Kinematics, the scenario is just the opposite. Here the position and the orientation of the end-effector is known and the joint angles that would achieve this pose must be calculated.
